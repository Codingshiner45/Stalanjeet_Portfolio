...
<body>
    ...
    <div class="container">
      ...
      <nav id="navbar" class="navbar">
        <ul>
		  ...
		  <li><a class="nav-link" href="test_index.php" target="_blank">CRUD With PHP &amp MySQL </a></li>
        </ul>
  ...
  <h2>What is Full Stack Web Developer</h2>
	  <h2>full stack web developer is a professional who is proficient in both frontend and backend web development.Frontend development involves creating the visual elements of a website or web application that users interact with directly. This includes designing and implementing the user interface (UI) and user experience (UX) using languages such as:
HTML (Hypertext Markup Language): Defines the structure of web pages.
CSS (Cascading Style Sheets): Styles the HTML elements to enhance the appearance of the website.
JavaScript: Adds interactivity and dynamic functionality to web pages. Frontend developers often use libraries and frameworks like React.js, Angular, or Vue.js to streamline development and enhance the user experience.</h2>
  ...
  <section id="about" class="about">
    ...
    <div class="about-me container">
      ...
      <div class="section-title">
		...
		<h4> Hello there! I'm Stalanjeet Singh, a passionate junior web developer with a keen eye for design and a love for creating engaging digital experiences. Ever since I first laid my hands on HTML and CSS, I've been captivated by the endless possibilities of the web.

I thrive on turning ideas into reality through code, constantly seeking out new technologies and techniques to refine my skills. My journey into web development started with a curiosity-driven dive into online tutorials and courses, which quickly evolved into a full-blown passion.

Driven by a desire to constantly improve, I immerse myself in projects that challenge me to learn and grow. Whether it's building responsive websites, crafting intuitive user interfaces, or delving into the intricacies of backend development, I approach each task with enthusiasm and a hunger for knowledge.

Beyond coding, I bring a creative mindset and an eye for detail to every project. I believe that great design goes hand in hand with functionality, and I'm committed to delivering seamless user experiences that leave a lasting impression.

I'm excited to be on this journey in the ever-evolving world of web development, and I'm eager to collaborate with fellow developers and designers to bring innovative ideas to life.

When I'm not coding, you can find me exploring the great outdoors, indulging in my love for photography, or diving into a good book.

Let's connect and create something amazing together!</h4>
      </div>

      <div class="row">
        <div class="col-lg-4" data-aos="fade-right">
          <img src="assets/img/img1.png" class="img-fluid" alt="" style=" width: 80%;">
        </div>
...
-->
      ...
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="resume-item pb-0">
            <h4>Upwork Design Development Company</h4>
            <p><em>Innovative and deadline-driven web Designer with 1+ years of experience designing and developing user generated ideas  from initial concept to final, polished deliverable.</em></p>
            <p>
            <ul>
              <li>ABC Street 127,Uk</li>
              <li>(+44)7480921666 </li>
              <li>stalanjeet@upwork.com</li>
            </ul>
            </p>
          </div>
          ...
          <div class="resume-item">
            ...
            <h5>2021 - 2024</h5>
            <p><em>University of Sunderland UK</em></p>
            <p>Several acedemic courses taught includes 
			<ul>
          ...
          <div class="resume-item">
            ...
            <h5>2019 - 2020</h5>
            <p><em> ABC Institue of Web Development  </em></p>
            <p>Different tools learned includes 
			<ul>
			<li>WordPress</li>
			<li>Sublime Text</li>
			<li>Atom &amp others</li>
			</p>
			</ul>
          </div>
        </div>
  ...
  <section id="portfolio" class="portfolio">
    <div class="container">
	  ...
	  <a href="test_index.php" target="_blank">
	  <button>Database Insertion, deletion (Employee Registeration)</button>
	  </a>
